...
import { CommonModule } from '@angular/common';
  @Component({
    ...
    imports: [AddUtilisateurComponent,EditUtilisateurComponent,ReactiveFormsModule,CommonModule], // Dépendances importées
    ...
    get_utilisateur() {
      ...
      this.api.taf_post("utilisateur/get", {}, (reponse: any) => {
        if (reponse.status) {
          ...
          console.log("users",this.les_utilisateurs)
...
openImageModal(src: string | null): void {
  this.modalImage = src || 'assets/img/default.png';
  const modal = new (window as any).bootstrap.Modal(document.getElementById('imageZoomModal'));
  modal.show();
}
